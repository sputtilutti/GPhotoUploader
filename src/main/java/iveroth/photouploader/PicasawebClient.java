 ...
 *
 *
 * Stolen in Sep 2017 (and slightly modified) from Google Data API sample
 * (v1.47.1): https://github.com/google/gdata-java-client
 * 
 */
public class PicasawebClient {
	...
	public List<AlbumEntry> getAlbums(String username) throws IOException, ServiceException {
		...
		albumUrl = addKindParameter(albumUrl, "album");
	...
	public AlbumEntry addAlbum(String title) throws IOException, ServiceException {
		AlbumEntry e = new AlbumEntry();
		e.setTitle(TextConstruct.plainText(title));
		return this.insertAlbum(e);
	}
	...
	public List<TagEntry> getTags(String uname) throws IOException, ServiceException {
		String tagUrl = API_PREFIX + uname;
		tagUrl = addKindParameter(tagUrl, "tag");
